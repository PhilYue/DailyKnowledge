...
export default {
  ...
  methods: {
    ...
    //         }
    //       } else {
    //         if (data[p].resHouseSpaceBeanList[i].rentalPrice !== '' && data[p].resHouseSpaceBeanList[i].rentalPrice !== null) {
    //           data[p].resHouseSpaceBeanList[i].rentalPrice1 = data[p].resHouseSpaceBeanList[i].rentalPrice / 1000 + '元/月'
    //         } else {
    //           data[p].resHouseSpaceBeanList[i].rentalPrice1 = '暂无定价'
    //         }
    //       }
    //       if (data[p].resHouseSpaceBeanList[i].houseSpaceName !== '' && data[p].resHouseSpaceBeanList[i].houseSpaceName !== null) {
    //         data[p].roomNo1 = data[p].roomNo + '' + data[p].resHouseSpaceBeanList[i].houseSpaceName
    //       } else {
    //         data[p].roomNo1 = data[p].roomNo
    //       }
    //       data[p].resHouseSpaceBeanList[i].houseSpaceArea1 = data[p].resHouseSpaceBeanList[i].houseSpaceArea / 1000
    //       data[p] = Object.assign(data[p], data[p].resHouseSpaceBeanList[i])
    ...
    houseCardListShow (houseList, data, ev) {
      if (!houseList.listShow) {
        let dataList = {
          // loginId: this.searchList.loginId,
          // houseSpaceManagerType: this.searchList.houseSpaceManagerType,
          // houseSpaceProcess: this.searchList.houseSpaceProcess,
          // loginId: this.searchList.loginId,
          // otherHouseSpaceStatus: this.searchList.otherHouseSpaceStatus,
          propertyType: this.searchList.propertyType,
          zoneId: this.searchList.zoneId,
          keywordAddress: this.searchList.keywordAddress,
          ...
          blockName: houseList.blockName,
          buildingNo: houseList.buildingNo,
          isLoginId: true,
          otherHouseSpaceStatus: null, // Edit by Mark. Reqeusted by Lu. // this.newStatus,
        }
        // this.searchList.pageSize = null
        // this.searchList.pageNo = null
    ...
    addFile (value) {
      value.houseSpaceId = value.resHouseSpaceBeanList[0].houseSpaceId
      this.$emit('addFile', value)
    },
    synchronization (value) {
      value.houseSpaceId = value.resHouseSpaceBeanList[0].houseSpaceId
      value.keywordAddress = value.resHouseSpaceBeanList[0].keywordAddress
