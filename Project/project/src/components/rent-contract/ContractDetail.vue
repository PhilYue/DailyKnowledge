<template>
  <div>
            ...
            <div class="contain">
              <div class="clear">
                ...
                <el-col v-if="detailData.certificateType" :span="16">
                  ...
                  <div v-else-if="detailData.certificateType === 'BL'" class="content">营业执照</div>
              ...
              <div class="clear">
                ...
                <el-col v-if="detailData.contractPdf" :span="8" class="title">电子合同PDF</el-col>
                <el-col v-if="detailData.contractPdf" :span="16">
                  <a target="_blank" :href="detailData.contractPdf">点击查看</a>
                </el-col>
              ...
              <!-- 图片信息 -->
              <div v-if="detailData.attachmentList.length !== 0" class="clear">
                <h3>图片信息</h3>
                <img-list @refreshDetail="refreshDetail" :typeId="detailData.id" :data="detailData.attachmentList"></img-list>
              </div>
            </div>
          </el-col>
        </el-row>
    ...
    <!-- 租约详情子组件 -->
    <lease-detail :detailShow="leaseDetailShow" :leaseId="leaseId"></lease-detail>
  </div>
</template>
<script>
