      ...
      <!-- 头部搜索和筛选 -->
        ...
        <div class="main-right-main">
          <div class="list-contain">
            ...
            <!-- 列表组件 -->
              <reserve-list :listData="listData">
          ...
          <!-- 详情组件 -->
          <reserve-house-detail :detailShow="detailShow" :reserveHouseId="reserveHouseId"></reserve-house-detail>
        </div>
      </div>
  </div>
</template>
...
// 列表组件
import ReserveList from '@/components/rent/ReserveList'
// 表单组件
