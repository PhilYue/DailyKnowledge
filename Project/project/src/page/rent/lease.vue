  ...
  <div>
      ...
      <!-- 头部搜索和筛选 -->
          ...
          <div>
            ...
            <el-dropdown menu-align="start" class="el-dropdown" @command="handleCommand2">
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item command="已搬入1天">已搬入1天</el-dropdown-item>
                <el-dropdown-item command="已搬入3天">已搬入3天</el-dropdown-item>
                <el-dropdown-item command="已搬入5天">已搬入5天</el-dropdown-item>
                ...
                <el-dropdown-item command="已搬入30天">已搬入30天</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
            <!-- 公共片区筛选组件 -->
        ...
        <div class="main-right-main">
          ...
          <!-- 退租表单组件 -->
          <cancel-rent-form :cancelRentForm="cancelRentForm" :cancelRentFormShow="cancelRentFormShow" :cancelRentFormData="cancelRentFormData"></cancel-rent-form>
          <!-- 转租表单组件 -->
          <change-rentForm :changeRentForm="changeRentForm" :changeRentFormShow="changeRentFormShow" :changeRentFormData="changeRentFormData"></change-rentForm>
          <!-- 换房表单组件 -->
          <huan-rent-form
...
import Merge from '@/components/rent/Merge' // 合并费用的组件
import CancelRentForm from '@/components/rent/CancelRentForm' // 退租表单申请组件
import ChangeRentForm from '@/components/rent/ChangeRentForm' // 转租表单申请组件
import HuanRentForm from '@/components/rent/HuanRentForm' // 换房表单申请组件
  ...
  methods: {
    ...
    handleCommand2 (command) {
      ...
      if (command === '已搬入天数') {
        this.bean.searchDays = null
        this.bean.searchType = null
      } else if (command === '已搬入1天') {
        this.bean.searchDays = 1
        this.bean.searchType = 'ALIN'
      } else if (command === '已搬入3天') {
        this.bean.searchDays = 3
        this.bean.searchType = 'ALIN'
      } else if (command === '已搬入5天') {
        this.bean.searchDays = 5
        this.bean.searchType = 'ALIN'
