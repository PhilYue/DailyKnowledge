  ...
  if (!store){
    ...
    store = new Vuex.Store({
      state: {
        ...
        houseData: '',
        count: 0,
        apiUrl: 'http://116.62.166.134:',
        // rent服务接口地址
        rentUrl: 'http://116.62.166.134:23150/rent/',
        // house房源接口地址
        houseUrl: 'http://116.62.166.134:23222/house/',
        // contract合同接口地址
        contractUrl: 'http://116.62.166.134:23250/contract/',
        // account登录接口地址
        accountUrl: 'http://116.62.166.134:21000/account/',
        // pdf接口地址
        pdfUrl: 'http://116.62.166.134:21350/oss/',
        // pay接口地址
        payUrl: 'http://116.62.166.134:21550/pay/',
        // 工作流接口地址
        workflowUrl: 'http://116.62.166.134:21600/workflow/',
        // 售后服务接口地址
        serviceUrl: 'http://116.62.166.134:23300/maintain/',
        // 搜索引擎接口地址
        searchUrl: 'http://116.62.166.134:21275/search/',
        // 维修物品接口地址
        categoryUrl: 'http://116.62.166.134:21275/data/',
        // 三级联动接口地址
        blockUrl: 'http://116.62.166.134:21275/block/',
        // 同步房源数据到蘑菇租房
        alipayUrl: 'http://116.62.166.134:21650/house/sync/',
        // 智能门锁
        lockUrl: 'http://116.62.166.134:21151/lock/',
        // 优惠规则接口
        ruleUrl: 'http://116.62.166.134:21777/sale/',
        currentUser: {
          get userName () {
