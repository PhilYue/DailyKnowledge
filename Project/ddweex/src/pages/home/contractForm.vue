  ...
  <div class="wrapper">
    <div v-show="contractFormShow">
      ...
      <div class="zk-form">
        ...
        <div class="zk-form-div-b" @click="getRule">
      ...
      <div class="zk-form">
        ...
        <!-- 最多可居住人数 -->
        <div class="zk-form-div-b" @click="chooseLivesNumber">
      ...
      <!-- 身份证正面 -->
      <!-- <div class="idCardImg-div">
        <image @click="getPositive" :src="PositiveImg" class="idCardImg"  resize="contain"></image>
      </div> -->
      <!-- 身份证反面 -->
      <!-- <div class="idCardImg-div">
        <image @click="getReverse" class="idCardImg" :src="ReverseImg" resize="contain"></image>
      </div> -->
      <!-- 底部按钮 -->
...
export default {
  ...
  data: function(){
    return {
      // 正面照
      PositiveImg: 'https://sayyoo-bucket-image.oss-cn-hangzhou.aliyuncs.com/zhengmian.png',
      // 反面照片
      ReverseImg: 'https://sayyoo-bucket-image.oss-cn-hangzhou.aliyuncs.com/beimian.png',
      // 流程数据
      contractFormData: {
  ...
  created: function () {
    // alert(JSON.stringify(dingtalk.config()))
    // if (!this.configTrue) {
    //   this.config()
    // }
  },
  methods: {
      ...
      dingtalk.ready(function(){
        ...
        dd.biz.util.uploadImageFromCamera({
          ...
          onSuccess : function(result) {
            that.PositiveImg = result
            that.submitForm.addrFront = result[0]
          },
          onFail : function(err) {
            console.log(err)
          }
    ...
    getReverse: function (e) {
      ...
      dingtalk.ready(function(){
        ...
        dd.biz.util.uploadImageFromCamera({
          ...
          onSuccess : function(result) {
            that.ReverseImg = result
            that.submitForm.addrReverse = result[0]
          },
          onFail : function(err) {
            console.log(err)
          }
      ...
      dingtalk.ready(function(){
        ...
        dd.biz.util.datepicker({
          ...
          onSuccess : function(result) {
            ...
            that.submitForm.startTime = Date.parse(result.value) - 28800000
      ...
      dingtalk.ready(function(){
        ...
        dd.biz.util.datepicker({
          ...
          onSuccess : function(result) {
            ...
            that.submitForm.endTime = Date.parse(result.value) - 28800000
            if (that.ruleData.rental) {
              that.resetRule()
            }
          },
      ...
      dingtalk.ready(function(){
        ...
        dd.biz.util.chosen({
         ...
         onSuccess : function(result) {
            ...
            } else if (result.key === '顾寓不规则计费') {
              that.rule.cycle = 'GYIRRE'
            }
            if (that.ruleData.rental) {
              that.resetRule()
            }
    ...
    goNext:function (e) {
      ...
      // } else if (!this.submitForm.addrFront) {
      //   dingtalk.ready(function(){
      //     const dd = dingtalk.apis;
      //     dd.device.notification.alert({
      //       message: '请上传身份证正面照',
      ...
      //     });
      //   });
      // } else if (!this.submitForm.addrReverse) {
      //   dingtalk.ready(function(){
      //     const dd = dingtalk.apis;
      //     dd.device.notification.alert({
      //       message: '请上传身份证反面照',
