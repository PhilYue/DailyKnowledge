            ...
            <!-- 费用信息 -->
              <div class="clear">
                ...
                <el-col v-if="payData.payPurposeType" :span="16" class="">
                  ...
                  <span v-else-if="payData.payPurposeType === 'WATER'" class="content dpl">水费.{{payData.periodNumber}}期</span>
                  <span v-else-if="payData.payPurposeType === 'ELEC'" class="content dpl">电费.{{payData.periodNumber}}期</span>
                  <span v-else-if="payData.payPurposeType === 'GAS'" class="content dpl">煤气费.{{payData.periodNumber}}期</span>
                  <span v-else-if="payData.payPurposeType === 'COM'" class="content dpl">赔偿费.{{payData.periodNumber}}期</span>
                  <span v-else-if="payData.payPurposeType === 'CLEAN'" class="content dpl">清洁费.{{payData.periodNumber}}期</span>
                  <span v-else-if="payData.payPurposeType === 'MAIN'" class="content dpl">维修费.{{payData.periodNumber}}期</span>
                  <span v-else-if="payData.payPurposeType === 'CONSUME'" class="content dpl">消费.{{payData.periodNumber}}期</span>
                  <span v-else-if="payData.payPurposeType === 'OTH'" class="content dpl">其他.{{payData.periodNumber}}期</span>
                  <span v-else-if="payData.payPurposeType === 'PERFEE'" class="content dpl">物管费.{{payData.periodNumber}}期</span>
                  <span v-else-if="payData.payPurposeType === 'MANAGECOST'" class="content dpl">手续费.{{payData.periodNumber}}期</span>
                ...
                <div v-if="payData.mergedSubOrders" class="clear">
                  <div :class="[index % 2 === 0 ? activeClass : '', fl, w50p]" v-for="(item,index) in payData.mergedSubOrders">
                      ...
                      <el-col v-if="item.payPurposeType" :span="16" class="">
                        ...
                        <div v-else-if="item.payPurposeType === 'WATER'" class="content dpl">水费.{{item.periodNumber}}期</div>
                        <div v-else-if="item.payPurposeType === 'ELEC'" class="content dpl">电费.{{item.periodNumber}}期</div>
                        <div v-else-if="item.payPurposeType === 'GAS'" class="content dpl">煤气费.{{item.periodNumber}}期</div>
                        <div v-else-if="item.payPurposeType === 'COM'" class="content dpl">赔偿费.{{item.periodNumber}}期</div>
                        <div v-else-if="item.payPurposeType === 'CLEAN'" class="content dpl">清洁费.{{item.periodNumber}}期</div>
                        <div v-else-if="item.payPurposeType === 'MAIN'" class="content dpl">维修费.{{item.periodNumber}}期</div>
                        <div v-else-if="item.payPurposeType === 'CONSUME'" class="content dpl">消费.{{item.periodNumber}}期</div>
                        <div v-else-if="item.payPurposeType === 'OTH'" class="content dpl">其他.{{item.periodNumber}}期</div>
                        <div v-else-if="item.payPurposeType === 'PERFEE'" class="content dpl">物管费.{{item.periodNumber}}期</div>
                        <div v-else-if="item.payPurposeType === 'MANAGECOST'" class="content dpl">手续费.{{item.periodNumber}}期</div>
