      ...
      <!-- 姓名手机号 -->
	      <el-form-item label="" prop="changeType">
		      <el-radio-group @change="getPay" v-model="changeRentForm.changeType">
		        <el-radio class="radio" label="SPAID">有偿转租</el-radio>
		        <el-radio class="radio" label="SNOTPAID">无偿转租</el-radio>
		      </el-radio-group>
	      </el-form-item>
...
export default {
  ...
  props: ['changeRentFormData', 'changeRentFormShow', 'changeRentForm']
}
</script>
<style scoped>
.w100p{
