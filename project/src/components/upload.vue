...
export default {
  ...
  methods: {
    ...
    submit () { // 上传图片
      console.log(this.clickOver)
      if (this.clickOver) {
        this.clickOver = false
        var _this = this
        // _this.urlLists.contractId = _this.uploadData.contract
        // var picAdd = this.$store.state.contractUrl + 'attachment/add'
        ...
        _this.$http.post(picToken, {
          ...
          if (res.body.code === 200) {
            ...
            // callback.callbackHost = 'oss-cn-hangzhou.aliyuncs.com'
            // callback.callbackBody = '{\"mimeType\":${mimeType},\"size\":${size}}'
            // callback.callbackBodyType = 'application/json'
            // console.log(callback)
            // let progress = 'ListMultipartUploads'
            var client = new OSS({
