          ...
          callback: (action, instance) => {
            ...
            if (action === 'confirm') {
              ...
              if (req.processBusinessType === 'maintain') {
                // 维保的链接
                apiUrl = 'http://116.62.166.134:23300' + actionUrl
              } else if (req.processBusinessType === 'rent') {
                // 新签合同链接
                apiUrl = 'http://116.62.166.134:23250' + actionUrl
              } else if (req.processBusinessType === 'renewal' && actionTarget === 'confirm.rent.contract.workflow') {
                // 续租第一步审核链接
                apiUrl = 'http://116.62.166.134:21600' + actionUrl
                ...
                // 退租第二步链接
                apiUrl = 'http://116.62.166.134:23150' + actionUrl
              }
              // 如果是合同同意取消
