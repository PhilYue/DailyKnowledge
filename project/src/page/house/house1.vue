    ...
    getUnitId (value) {
      ...
      if (this.elTabPane === 0) {
        ...
        let dataList1 = {
          ...
          originalRentType: 'ENTIRE_RENT',
          loginId: this.$store.state.currentUser.uid,
          keywordAddress: this.searchList1.keywordAddress,
          zoneId: this.zoneId || '',
        }
        ...
        this.$options.methods.houseSearch3(this, this.mix.houseResourcesUrl, dataList)
        let dataList1 = {
          pageNo: this.centralized.currentPage,
          pageSize: this.centralized.pageSize,
          houseSpaceManagerType: 'HOUSE',
          houseSpaceProcess: 'RENTABLE_PROCESS',
          propertyType: 'C',
          originalRentType: 'ENTIRE_RENT',
          loginId: this.$store.state.currentUser.uid,
          keywordAddress: this.searchList2.keywordAddress,
          zoneId: this.zoneId,
        }
