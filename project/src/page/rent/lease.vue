  ...
  <div>
      ...
      <!-- 头部搜索和筛选 -->
        ...
        <div class="main-right-main">
            ...
            <!-- 列表组件 -->
              <leaseList :listData="listData">
                <template slot-scope="props" class="pad9">
                  ...
                  <!-- 出租中显示的按钮 -->
                    <el-dropdown :show-timeout="0" :hide-timeout="0" v-if="listData[props.index].leaseStatus === 'RENTING' || listData[props.index].leaseStatus === 'HOLD' || listData[props.index].leaseStatus === 'NOEFFECT'" menu-align="start">
                      <el-button>
                        <span>操作</span>
                    ...
                    <!-- 已结束状态 -->
                    <el-dropdown v-else-if="listData[props.index].leaseStatus === 'END'" menu-align="start">
                      <el-button>
                        <span>操作</span>
                        <i class="el-icon-caret-bottom el-icon--right"></i>
                      </el-button>
          ...
          <!-- 退租表单组件 -->
          <cancelRentForm :cancelRentFormShow="cancelRentFormShow" :cancelRentFormData="cancelRentFormData"></cancelRentForm>
          <!-- 转租表单组件 -->
          <changeRentForm :changeRentFormShow="changeRentFormShow" :changeRentFormData="changeRentFormData"></changeRentForm>
          <!-- 换房表单组件 -->
          <huanRentForm :huanRentFormShow="huanRentFormShow" :huanRentFormData="huanRentFormData"></huanRentForm>
        </div>
      </div>
