      ...
      <div class="main-right-main">
        <div class="list-contain">
          <div class="list-contain-main">
            <contractList :listData="listData">
        ...
        <addPeopleForm :contractId="addPeopleFormId" :addPeopleFormShow="addPeopleFormShow"></addPeopleForm>
      </div>
    </div>   
  </div>
</template>
...
import addPeopleForm from '../../components/addPeopleForm' // 添加随住人员组件
